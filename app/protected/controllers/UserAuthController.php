...
class UserAuthController extends Controller {
    ...
    public function actionIndex(){ // is admin -> redirect to manage-member
        if(Yii::app()->user->isAdmin()){
            ...
            $this->render('/userauth/index', array(
                'pages' => $pages,
            ));
        }else
    ...
    public function actionManageMemberAjax(){
        if(Yii::app()->user->isAdmin()){
            ...
            echo CJSON::encode(array(
                    'tbody_member' => $this->renderPartial('/userauth/_manage-member-ajax', array(
                                    'model' => $model,
                                    'offset' => $offset + 1
                                ), true
                    ),
    ...
    public function actionAccount(){
        ...
        $this->render('/userauth/_account-setting', array(
            'menu_active' => 'account',
            'model' => $model
        ));
    }
    ...
    public function actionChangePasswordForm(){
        $this->render('/userauth/_change-password-form', array(
            'menu_active' => 'account'
        ));
    }
