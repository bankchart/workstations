<div class='well'>
    ...
    <div class='row'>
        <div class='col-sm-12'>
            <button class='btn btn-default' id='allow-btn' class='multiple-perform'>allow</button>
            <button class='btn btn-default' id='remove-btn' class='multiple-perform'>remove</button>
            <button class='btn btn-default' id='ban-btn' class='multiple-perform'>ban</button>
            <div class='pull-right'>
                <label>page :</label>
